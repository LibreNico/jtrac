...
public class ItemViewPanel extends BasePanel {
    ...
    private void addComponents(final Item item) {
        ...
        add(new Label("detail", item.getDetail()).setEscapeModelStrings(false));
        ...
        add(new ListView("fields", item.getSpace().getMetadata().getFieldOrder()) {
            ...
            protected void populateItem(ListItem listItem) {
                ...
                listItem.add(new Label("value", item.getCustomValue(fieldName)).setEscapeModelStrings(false));
            }
        });
        ...
        if (item.getHistory() != null) {
            ...
            add(new ListView("history", history) {
                ...
                protected void populateItem(ListItem listItem) {
                    ...
                    comment.add(new Label("comment", h.getComment()).setEscapeModelStrings(false));
                    ...
                    listItem.add(new ListView("fields", editable) {
                        ...
                        protected void populateItem(ListItem listItem) {
                            Field field = (Field) listItem.getModelObject();
                            listItem.add(new Label("field", h.getCustomValue(field.getName())).setEscapeModelStrings(false));
                        }
                    });
                }
            });
